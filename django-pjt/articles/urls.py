...
from .views import ArticleListCreateAPIView, ArticleDetailAPIView, UserArticleListAPIView, ArticleLikeAPIView, ArticleListAPIView
...
urlpatterns = [
    ...
    path('articles/<int:pk>/', ArticleDetailAPIView.as_view(), name='article_detail'),  # 수정
